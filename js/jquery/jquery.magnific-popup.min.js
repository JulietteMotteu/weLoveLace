...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MzMxNTU5OTU3OjNlMmVmZmIwNmIwZGMzZWU3ZmEzYjc3MTgwZDVhMDZhY2M0NWIzNmY4MTQzZTFiMDZhYzdjNmRmNzE0Mzc3YmQ=--525ba83304ed466eb48a9f553c5e451717390dce">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="D66A:3AAE:8E2207:FCFE0B:5BCDD58A" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="D66A:3AAE:8E2207:FCFE0B:5BCDD58A" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="42958861" /><meta name="octolytics-actor-login" content="juliette-m" /><meta name="octolytics-actor-hash" content="0764b3afffbbffe8cc0dfeb43071f5ee6bf057466530fa6becf7bd063b2dbae7" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="userId" content="fb59d9679a1b02a33c76ee7628b6dd16" %>
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="juliette-m">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="MTBkNDcxMzE3MmFmNjljMjI4NGE5N2QxNmNmOTc1NmJmY2EwNjY5OWUwYTMwNDg4NDlkNzA3N2E3MGFmZTc3NXx7InJlbW90ZV9hZGRyZXNzIjoiMTA5Ljg4LjIwLjIzNiIsInJlcXVlc3RfaWQiOiJENjZBOjNBQUU6OEUyMjA3OkZDRkUwQjo1QkNERDU4QSIsInRpbWVzdGFtcCI6MTU0MDIxNjIwOCwiaG9zdCI6ImdpdGh1Yi5jb20ifQ==">
  ...
  <meta name="html-safe-nonce" content="924e2ed7f23b7b0c8cdf8ca600fc0540613c2e1f">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="7544081" data-scoped-search-url="/dimsemenov/Magnific-Popup/search" data-unscoped-search-url="/search" action="/dimsemenov/Magnific-Popup/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=JshU0y9p8G1TqKM1Faqntf3JEbJp1Ekxe5v5gi/sL8/48v+0Ar/zUa3i3/I2EbIttpjXSD/8Fzx8P0+VspFd9Q=="
          spellcheck="false"
          autocomplete="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:42958861" href="/notifications">
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@juliette-m" class="avatar float-left mr-1" src="https://avatars1.githubusercontent.com/u/42958861?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <ul>
          <li class="header-nav-current-user css-truncate"><a role="menuitem" class="no-underline user-profile-link px-3 pt-2 pb-2 mb-n2 mt-n1 d-block" href="/juliette-m" data-ga-click="Header, go to profile, text:Signed in as">Signed in as <strong class="css-truncate-target">juliette-m</strong></a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="/juliette-m" data-ga-click="Header, go to profile, text:your profile">Your profile</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/juliette-m?tab=repositories" data-ga-click="Header, go to repositories, text:your repositories">Your repositories</a></li>


          <li><a role="menuitem" class="dropdown-item" href="/juliette-m?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a></li>
            <li><a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, your gists, text:your gists">Your gists</a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">Help</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/settings/profile" data-ga-click="Header, go to settings, icon:settings">Settings</a></li>
          <li>
            <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="amS7cROQg/MtzO2pG8Wuyd7hXKiS5BtTnX2Y59Ewg+AFywBDQnKP/XEJaD5XIq5ZQ8cAgMwf+AEtruZnFe3iag==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="OVVnmIR5BxU3MpFeOTwAloUUM5dp3G2+zJA50lZG5HFW+tyq1ZsLG2v3FMl12wAGGDJvvzcnjux8Q0dSkpuF+w==" />
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-remote="true" class="js-social-form js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="HNSuFop1lm3vSuKo70d1HqQLGurjgnZ9SnX+004Y9RadEGcr3Gt58jMdMqBw2oBR1b96DxVsgm+jHD1381bsXg==" />      <input type="hidden" name="repository_id" id="repository_id" value="7544081" class="form-control" />
      ...
      <a class="social-count js-social-count"
        ...
        aria-label="413 users are watching this repository">
        413
      </a>
</form>
  </li>
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/dimsemenov/Magnific-Popup/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="tzdKu8E8SgmUv2eW1OcmiEplnsIRUZfsGF65yqQkzj6z4Dh4hvkiKNg9ydQPENed/La6kZbKdTwUTEk8BgnBMw==" />
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/dimsemenov/Magnific-Popup/stargazers"
           aria-label="10460 users starred this repository">
          10,460
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/dimsemenov/Magnific-Popup/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="v5IkR1PNBQ1242bfpXGDWphM6FJ8VRHeQrFFjxZO2zeVMe6M7qA+bn5x/EDPNTQA5WU3Bnjykg7UxM58bZ6Rvg==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/dimsemenov/Magnific-Popup/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="VInQ0ZI80nkmOFvCcCI0GBJGGFobR5X+pcki6wVA/pjgbkf0/R8S+5VnPRql9gdHgh5T+5wKlJg04GG/Qg8lLg==" />
            <button
                type="submit"
    ...
    <a href="/dimsemenov/Magnific-Popup/network/members" class="social-count"
       aria-label="2848 users forked this repository">
      2,848
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse alerts /dimsemenov/Magnific-Popup/pulse" href="/dimsemenov/Magnific-Popup/pulse">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/dimsemenov/Magnific-Popup/blame/c8f6b8549ebff2306c5f1179c9d112308185fe2c/dist/jquery.magnific-popup.min.js">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" role="menuitem" href="/dimsemenov/Magnific-Popup/issues/new">Open new issue</a></li>
      </ul>
    </details-menu>
  </details>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.35288s from unicorn-5994744f98-zkq92">GitHub</span>, Inc.</li>
